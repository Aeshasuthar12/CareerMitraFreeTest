...
career_map = {
    "Analytical & Tech": ["Software Engineer", "Data Scientist", "AI Engineer"],
    "Business & Management": ["Entrepreneur", "Business Analyst", "Product Manager"],
    "Creative & Media": ["Graphic Designer", "Content Creator", "Film Maker"],
    "People & Helping": ["Psychologist", "Teacher", "HR Manager"],
    "Practical & Operations": ["Mechanical Engineer", "Civil Engineer", "Operations Manager"],
    "Structure & Detail": ["Accountant", "Auditor", "Project Planner"],
}
